          ...
          <div className="mx-auto max-w-3xl">
            <header className="text-center">
              {cart.length > 0 ? (
                ...
                <h5 className="text-base font-bold text-gray-900 sm:text-xl">Your cart is empty 🛒, but your next great purchase is just a click away! ✨ 🛍️ </h5>
              )}
            </header>
                ...
                {cart.length > 0
                  ? cart.map((item) => (
                      <li className="flex items-center gap-4" key={item.id}>
                        ...
                        <div>
                          <h3 className="text-sm text-gray-900">{item?.title || "Product Title"}</h3>
                        ...
                        <div className="flex flex-1 items-center justify-end gap-2">
                          ...
                          <button onClick={() => handleRemoveFromCart(item)} className="text-gray-600 transition hover:text-red-600">
